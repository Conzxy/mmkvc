#ifndef _MMKVC_CONFIGD_CLIENT_H__
#define _MMKVC_CONFIGD_CLIENT_H__
...
class ConfigdClient {
 ...
 private:
  ...
  algo::AvlDictionary<shard_id_t, NodeEndPoint, algo::Comparator<shard_id_t>>
      shard_endpoint_dict_;
